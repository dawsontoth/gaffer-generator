...
/**
 * Reports a problem with one .templateroot. The remaining .templateroots are still
 * processed, but the CLI must exit non-zero so callers can tell the run was incomplete.
 */
